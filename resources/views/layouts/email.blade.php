                                    ...
                                    <tbody style="-webkit-text-size-adjust: none">
                                        <tr style="-webkit-text-size-adjust: none">
                                            <td style="-webkit-text-size-adjust: none;">
                                                ...
                                                <div style="background-image: url('{{asset('email/acxchangeHeader.jpg')}}'); background-repeat: no-repeat;height:85px;">
                                                </div>
                                                ...
                                                <td style="-webkit-text-size-adjust: none;">
                                                    ...
                                                    <div style="background-image: url('{{asset('email/email_box.png')}}'); background-repeat:repeat-y;-webkit-text-size-adjust: none; color: #525C65; line-height: 22px; margin-top:0;margin-bottom:0;margin-left:0;margin-right: 0;padding-left:75px;padding-right:75px; text-align: justify;padding-top:20px;">
                                                        <p style="margin-top:0;margin-bottom:20px;margin-left:0;margin-right: 0;padding-right:60px;">
                                                            <span style="margin-top:5px;margin-bottom:5px;font-weight: bold;font-size:16px;font-family: 'Open+Sans', 'Open Sans', Helvetica, Arial, sans-serif;">@lang('email.Dear') @yield('user')</span>
                                                        </p>
                                                        <div style="-webkit-text-size-adjust: none; -webkit-text-stroke-width: 0px; color: rgb(82, 92, 101); display: inline !important; float: none; font-family: 'Open+Sans', 'Open Sans', Helvetica, Arial, sans-serif; font-size: 14px;padding:0;">
                                                            @yield('content')
                                                        </div>
                                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="-webkit-text-size-adjust: none;">
                                                            <tbody style="-webkit-text-size-adjust: none;">
                                                            <tr style="-webkit-text-size-adjust: none;">
                                                                <td style="-webkit-text-size-adjust: none;">
                                                                    <p style="margin-top:20px;margin-bottom:0;margin-left:0;margin-right: 0; text-align: left;font-weight: 600;font-family: 'Open+Sans', 'Open Sans', Helvetica, Arial, sans-serif;font-size:14px;padding-right:60px;">@lang('email.BestWish')</p>
                                                                </td>
                                                            </tr>
                                                            <tr style="-webkit-text-size-adjust: none;">
                                                                <td style="-webkit-text-size-adjust: none;">
                                            ...
                                            <tr  style="-webkit-text-size-adjust: none">
                                                ...
                                                <td style="-webkit-text-size-adjust: none;">
                                                    <div style="background-image: url('{{asset('email/acxchangeFooter.jpg')}}'); background-repeat: no-repeat;height:112px;"></div>
                                                </td>
                                            </tr>
                                        </tr>
                                    </tbody>
