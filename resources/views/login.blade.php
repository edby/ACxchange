...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/ac/index.css') }}?{{random_int(100,999999)}}">
    ...
    <script src="{{ asset('js/ac/index.js') }}?{{random_int(100,999999)}}"></script>
    <script>
        //語言設置
        ...
        <ul>
            ...
            <li class="login-right">
                ...
                <div class="signUp" style="display:none">
                    ...
                    <form>
                        <div class="form-group account">
                            <input type="text" name="" class="userName" placeholder="Please enter your name" onblur="userNameReg()">
                            <span class="userError"></span>
                        </div>
                        <div class="form-group password">
                            <input type="email" name="" class="email" placeholder="Please enter your Email" onblur="emailReg()">
                            <span class="emailRight"></span>
                        </div>
                        <div class="form-group password">
                            <input type="email" name="" class="emailAgain" placeholder="Please enter your Email again" onblur="emailAgainReg()">
                            <span class="emailReRight"></span>
                        </div>
                        <div class="form-group password">
                            <input type="password" name="" class="upPassReg" placeholder="Please enter your password" onblur="upPassReg()">
                            <span class="upPass"></span>
                        </div>
                        <div class="form-group password">
                            <input type="password" name="" class="upPassAgain" placeholder="Please enter password again" onblur="upPassAgain()">
                        ...
                        <div class="form-group signBottom">
                            <div class="leftcheck" id="layerDemo">
                                <input type="checkbox" name="" value="rembered">&nbsp;I have read <a href="#" class="treams"> Terms and Conditions</a> and agreed to <a href="javascript:0" class="privacy">@lang("ac.PrivacyPolicy")</a>.
                            </div>
                            <!-- <div class="rightForget">
...
<script type="text/javascript">
    ...
    function upPassAgain(){
        if($('.upPassAgain').val() == ''){
            ...
            $('.passReRight').text("Well done").show().css('color','#5fcc29');
        }
    }
</script>
</body>
